 ...
 *
 * Point-and-click adventure. No HP, no combat.
 * Characters are resolved via puzzle encounters.
 */
...
window.FRT.GameState = class GameState {
    ...
    addCharacterToRoom(charId, roomId) {
        roomId = roomId || this.player.currentRoom;
        var room = this.rooms[roomId];
        ...
        this.eventBus.emit('character:added', { characterId: charId, roomId: roomId });
    }
